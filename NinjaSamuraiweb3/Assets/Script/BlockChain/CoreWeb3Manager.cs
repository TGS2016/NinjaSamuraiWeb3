...
public class CoreWeb3Manager : MonoBehaviour
{
    ...
    // address of contract
    public const string contract = "0x9985F964d9a39BaC81529bb49af770D1Bbd464dE";
    public const string contractToken = "0xca39deE8Bc83d428aA8C87a26D93798ed92BE243";
   ...
   // const string chain = "polygon";
    ...
    public async UniTaskVoid getTokenBalance()
    {
        ...
        try
        {
            ...
            try
            {
                ...
                if (Web3_UIManager.Instance) { Web3_UIManager.Instance.SetTokenBalanceText(); }
    ...
    {
        if (MessageBox.insta) MessageBox.insta.showMsg("Claiming Token...\nPlease see and confirm transaction", false);
